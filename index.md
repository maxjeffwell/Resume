...
React 16-18, JavaScript ES6+, HTML5/CSS3, Redux/Redux Toolkit, React Hooks, Context API, React Router, Styled Components, Tailwind CSS, Webpack, Babel, Gatsby, Responsive Design

### Backend Development
Node.js, Express, GraphQL, Apollo Server/Client, RESTful APIs, JWT Authentication, Passport.js, Middleware, Error Handling, API Design, Data Validation
